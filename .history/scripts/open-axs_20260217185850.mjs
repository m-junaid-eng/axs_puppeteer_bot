...
const SUPABASE_URL = process.env.SUPABASE_URL ?? 'https://lnkaympiinecpfumfvei.supabase.co/';
const SUPABASE_PUBLISHABLE_KEY =
  process.env.SUPABASE_PUBLISHABLE_KEY ?? 'sb_publishable_StFc8yTai0HtpNV8eVCgHQ_6dmbsNfJ';
