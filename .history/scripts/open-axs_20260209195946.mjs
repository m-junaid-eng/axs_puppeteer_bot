...
async function main() {
 ...
 // --- OXYLABS UK CONFIGURATION ---
const PROXY_USER = 'your_oxylabs_username'; // From your Oxylabs dashboard
const PROXY_PASS = 'your_oxylabs_password';
const UK_PORT = '8006'; // Port 8006, 8007, or 8008 for United Kingdom
const PROXY_SERVER = `http://isp.oxylabs.io:${UK_PORT}`;

const { browser, page } = await connect({
    headless: false,
    args: [
        '--start-maximized',
        `--proxy-server=${PROXY_SERVER}` // Routes traffic through the UK entry point
    ],
    customConfig: {},
    turnstile: true,
    connectOption: {
...
// Important: This handles the popup login for the proxy
