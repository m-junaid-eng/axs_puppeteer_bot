...
async function main() {
  ...
  headless: false,
  // If you use system chrome, make sure your regular Chrome is CLOSED 
  // or use a unique profile directory name
  userDataDir: path.join(profilesDir, 'axs-special-session'), 
  executablePath: executablePath ?? undefined,
  // This is the most important line for stopping the infinite loop
  ...
  args: [
    ...
    '--disable-infobars',
    '--start-maximized',
    // These two help with the "Target Closed" error on Windows
    '--disable-extensions',
