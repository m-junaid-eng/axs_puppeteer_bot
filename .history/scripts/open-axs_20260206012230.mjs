    ...
    if (supabaseMode) {
      ...
      for (let i = 0; i < urls.length; i++) {
        ...
        try {
          ...
          await entryPage.goto(inputUrl, { waitUntil: 'networkidle2', timeout: 60_000 });
          await sleep(1500);
          ...
          if (ticketsHref) {
            ...
            if (clickOutcome?.navigated) {
              ...
              await ticketsPage.setViewport({ width: 1280, height: 800, deviceScaleFactor: 1 });
              await ticketsPage.goto(ticketsHref, { waitUntil: 'networkidle2', timeout: 60_000, referer: inputUrl });
              await sleep(1500);
            }
          } else {
